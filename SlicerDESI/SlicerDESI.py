...
from SlicerDESILib.Logic import * 
from datetime import datetime

class SlicerDESI(ScriptedLoadableModule):
	"""
	...
	def __init__(self, parent):
		...
		self.parent.title = "SlicerDESI"  # TODO: make this more human readable by adding spaces
		...
		SlicerDESI is an extension developed for 3D Slicer that is responsible for the analysis of mass spectrometry data. 
		...
		Please cite the following publication: SlicerDESI"""
...
class SlicerDESITest(ScriptedLoadableModuleTest):
	...
	def runTest(self):
		...
		"""
		self.setUp()
		self.test_SlicerDESI1()

	def test_SlicerDESI1(self):
...
class SlicerDESIWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
	"""
	...
	def setup(self):
		...
		uiWidget = slicer.util.loadUI(self.resourcePath('UI/SlicerDESI.ui'))
